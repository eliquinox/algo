...
HD_PWD='/home/eliquinox/code/fpga/microblaze-ethernet/microblaze-ethernet.runs/top_auto_ds_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_auto_ds_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_auto_ds_1.tcl
